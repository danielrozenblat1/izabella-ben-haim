...
import logo from "../../images/איזבל בן חיים לוגו.png"
...
const NavBarNew = () => {
  ...
  const handleClick = () => {
    ...
    const message = "היי איזבל ,אני רוצה לשמוע ממך עוד על..";
        ...
        <div className={`${styles.mobileMenu} ${isClosing ? styles.closing : ''}`}>
          <div className={styles.mobileMenuContent}>
            ...
            <div className={styles.center}>
              <img className={styles.image} src={logo} alt="איזבל בן חיים לוגו"/>
            </div>
          </div>
        </div>
      )}
